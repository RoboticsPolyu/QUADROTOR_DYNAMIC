...
plt.title('Postion following residuals with tc=25ms based on JPCM')  

plt.tight_layout()
plt.savefig('time_constant25mspos.png',dpi=600, bbox_inches='tight')
...
plt.xlabel('time(0.01s)')
plt.title('Rotation following residuals tc=25ms based on JPCM')  
...
# plt.title('Position')   
plt.tight_layout()
plt.savefig('time_constant25msrot.png',dpi=600, bbox_inches='tight')
